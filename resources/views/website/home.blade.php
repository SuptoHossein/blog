        ...
        <div class="row align-items-stretch retro-layout-2">
            ...
            <div class="col-md-4">
                <a href="single.html" class="h-entry img-5 h-100 gradient"
                    style="background-image: url({{ asset('website/images/img_v_1.jpg') }});">
...
<div class="site-section">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="entry2">
                    <a href="single.html"><img src="{{ asset('website/images/img_3.jpg') }}" alt="Image"
                            class="img-fluid rounded"></a>
                    <div class="excerpt">
            ...
            <div class="col-lg-4 mb-4">
                <div class="entry2">
                    <a href="single.html"><img src="{{ asset('website/images/img_4.jpg') }}" alt="Image"
                            class="img-fluid rounded"></a>
                    <div class="excerpt">
